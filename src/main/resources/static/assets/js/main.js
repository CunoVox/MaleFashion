...
var gallery = document.querySelector('.product-gallery-slider-quickview img');
var currentIndex = 0;
var quickView = document.querySelectorAll('[href="#quickViewModal"]');
var descriptions = document.querySelectorAll('.product-info .descriptionHide')
var productDescription = document.querySelector('.product-description p')
var prices = document.querySelectorAll('.price')
var productPrice = document.querySelector('.product-price')
var productTitle = document.querySelector('.product-title')
var titles = document.querySelectorAll('.title [href="product-details.html"]')



// Get all the remove buttons
var removeButtons = document.querySelectorAll('.remove a.btn');

// Attach click event listener to each remove button
removeButtons.forEach(function(button) {
    button.addEventListener('click', function(event) {
        event.preventDefault(); // Prevent the default link behavior
        var row = this.closest('tr'); // Get the closest table row (tr) element
        row.remove(); // Remove the row from the table
    });
});

titles.forEach(function(element,index){
    console.log(titles[index].innerText)
})
...
quickView.forEach(function (element, index) {
    element.addEventListener('click', function () {
        var elementIndex = index;
        gallery.src = selectedImages[elementIndex].src;
        productDescription.innerText = descriptions[elementIndex].innerText;
        productTitle.innerText = titles[elementIndex].innerText;
      
        quickView.forEach(function (element) {
...
function redirectToPayment() {
    ...
    //         gallery.src = selectedImages[elementIndex].src;
    //         productDescription.innerText = descriptions[elementIndex].innerText;
    //         productPrice.innerText = prices[index].innerText;
    //         productTitle.innerText = titles[index].innerText;
    //         quickView.forEach(function (element) {
    //             element.removeEventListener('click', handleClick);
    //         });
    //     });
